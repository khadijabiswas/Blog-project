...
<x-breadcum rizvi="Blog's Edit Page"></x-breadcum>
            ...
            <div class="card-body">
                ...
                <form role="form" action="{{ route('blog.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="inputPassword3" placeholder="Blog Title" name="title" value="{{ $blog->title }}">
                            @error('title')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="short_description" id="textarea"> value="{{ $blog->short_description }}" </textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="description" id="textareaLong"> value="{{ $blog->description }}" </textarea>
                            @error('description')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <img id="cat" src="{{ asset('uploads/blog') }}/{{ $blog->thumnail }}" alt="" style="width: 100%; heght:300px; object-fit:content;">
